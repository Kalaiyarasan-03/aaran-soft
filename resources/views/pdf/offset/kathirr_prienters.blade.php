...
<table width="100%">
    ...
    @else
        <tr>
            ...
            <th colspan="2" style="padding: 1px; width: 1px; border-right: none;text-align: left; margin-bottom: 0;">%</th>
    ...
    @foreach($list as $index => $row)
        ...
        <tr>
            ...
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none;">{{$row['po_no']}} </td>
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none;">{{$row['dc_no']}} </td>
            <td align="left" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{$row['product_name']}}</td>
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;</td>
            <td align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{$row['qty']+0}}</td>
            <td align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format($row['price'],2,'.','')}}</td>
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format($row['qty']*$row['price'],2,'.','')}}</td>
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none; border-left: none;">{{$row['gst_percent']}}</td>
            <td align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format(($row['qty']*$row['price']*$row['gst_percent']/100)/2,2,'.','')}}</td>
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none; border-left: none;">{{$row['gst_percent']}}</td>
            <td align="center" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format(($row['qty']*$row['price']*$row['gst_percent']/100)/2,2,'.','')}}</td>
            <td align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format($row['qty']*$row['price']*$row['gst_percent']/100+$row['qty']*$row['price'],2,'.','')}}</td>
        </tr>
    ...
    @else
        @foreach($list as $index => $row)
            ...
            <tr>
                ...
                <td align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format($row['price'],2,'.','')}}</td>
                <td align="center" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format($row['qty']*$row['price'],2,'.','')}}</td>
                <td colspan="2" align="center" style="font-size: smaller; border-bottom: none;border-top: none; border-left: none;">{{$row['gst_percent']*2}}</td>
                <td colspan="2" align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format(($row['qty']*$row['price']*($row['gst_percent']*2)/100),2,'.','')}}</td>
                <td align="right" style="font-size: smaller; border-bottom: none;border-top: none;">&nbsp;{{number_format($row['qty']*$row['price']*$row['gst_percent']/100+$row['qty']*$row['price'],2,'.','')}}</td>
            </tr>
    ...
    <tr>
        ...
        <td align="right" style="border-bottom: none; border-left: none;font-weight: bold; font-size:medium;">{{number_format($obj->grand_total,2,'.','')}}</td>
    </tr>
    <tr>
