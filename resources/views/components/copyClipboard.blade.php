...
<div x-data="{
    ...
    <div x-show="copyNotification"
        ...
        <div
            class="px-3 h-7 -ml-1.5 items-center flex text-xs bg-blue-500 border-r border-blue-500 -translate-x-full text-white rounded">
            <span>Copied!</span>
            <div
    ...
    <div @click="copyClipboard({{$text}});"
        ...
        <svg x-show="copyNotification" class="w-4 h-4 text-blue-500 stroke-current" xmlns="http://www.w3.org/2000/svg"
