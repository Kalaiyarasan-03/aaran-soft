...
{{--        <div class="px-3 h-7 -ml-1.5 items-center flex text-xs bg-red-500 border-r border-red-500 -translate-x-full text-white rounded">--}}
{{--            <span>delete</span>--}}
{{--            <div class="absolute right-0 inline-block h-full -mt-px overflow-hidden translate-x-3 -translate-y-2 top-1/2">--}}
{{--                <div class="w-3 h-3 origin-top-left transform rotate-45 bg-red-500 border border-transparent"></div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--<button @click="click();" type='button' {{$attributes}}>--}}
{{--    <x-icons.icon :icon="'trash'"--}}
{{--                  class="text-red-500 h-5 hover:bg-red-500 hover:text-white px-0.5 py-0.5 hover:rounded-sm hover:font-bold"/>--}}
{{--</button>--}}
{{--</div>--}}
<div>
    <button {{ $attributes}} type='button' class="hover:bg-red-600 hover:text-white hover:rounded-sm">
