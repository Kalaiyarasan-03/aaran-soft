...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input.lookup-text','data' => ['wire:model.live' => 'vname','xRef' => 'vname','label' => 'Order','name' => 'vname']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'vname','x-ref' => 'vname','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Order'),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('vname')]); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal7d16718e6657ecb56d37e0c011ee97fc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7d16718e6657ecb56d37e0c011ee97fc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input.lookup-text','data' => ['wire:model.live' => 'order_name','xRef' => 'state_code','label' => 'Order Name','name' => 'order_name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input.lookup-text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'order_name','x-ref' => 'state_code','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Order Name'),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('order_name')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7d16718e6657ecb56d37e0c011ee97fc)): ?>
<?php $attributes = $__attributesOriginal7d16718e6657ecb56d37e0c011ee97fc; ?>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/livewire/controls/model/order/order-model.blade.php ENDPATH**/ ?>