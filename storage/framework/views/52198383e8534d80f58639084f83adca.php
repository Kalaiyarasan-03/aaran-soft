...
<head>
    ...
    <title>Invoice-<?php echo e($obj->invoice_no); ?></title>
    ...
    <tr>
        <td colspan="2" style="justify-items: center;">
            ...
            <div style="height: 100px;padding-left: 60px;" class="bg-blue-400 ">
                ...
                <div style="text-align: center; width: 100%;">&nbsp;<?php echo e($cmp->get('contact')); ?>

                    &nbsp;-&nbsp;<?php echo e($cmp->get('email')); ?></div>
...
<table width="100%">
    ...
    <?php if($obj->sales_type==0): ?>
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td align="center"
                    style="border-bottom: none;border-top: none; border-left: none;">&nbsp;<?php echo e($row['gst_percent']); ?>&nbsp;
                </td>
                <td align="right" style="border-bottom: none;border-top: none;">
                    <?php echo e(number_format($row['gst_amount'],2,'.','')); ?></td>
                <td align="center"
                    style="border-bottom: none;border-top: none; border-left: none;">
                    &nbsp;<?php echo e($row['gst_percent']); ?>&nbsp;
                </td>
                <td align="right" style="border-bottom: none;border-top: none;">
                    &nbsp;<?php echo e(number_format($row['gst_amount'],2,'.','')); ?></td>
                <td align="right" style="border-bottom: none;border-top: none; ">
        ...
        <tr>
            <td colspan="7" align="left"
                ...
                <div>sale of the goods specified in this invoice is made by us and the transaction of sale is covered by
    ...
    <?php else: ?>
        ...
        <tr>
            ...
            <td colspan="5" align="left" style="border-bottom: none;border-right: none;">IGST&nbsp;@&nbsp;<?php echo e($gstPercent); ?>%</td>
            <td align="right"
                style="border-bottom: none; border-left: none;"><?php echo e(number_format($obj->total_gst,2,'.','')); ?></td>
        </tr>
        <tr>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/pdf/offset/sales/sara_screens.blade.php ENDPATH**/ ?>