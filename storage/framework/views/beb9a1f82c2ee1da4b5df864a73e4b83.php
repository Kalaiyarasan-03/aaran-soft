...
<table width="100%">
    ...
    <tr>
        ...
        <td rowspan="4" width="40%" style="border-left: none;border-bottom: none;">
            <p style="line-height: .2;font-size: 20px;font-weight: bold;"><?php echo e($cmp->get('company_name')); ?></p>
            <p style="line-height: .5;"><?php echo e($cmp->get('address_1')); ?></p>
            <p style="line-height: .5;"><?php echo e($cmp->get('address_2')); ?></p>
            <p style="line-height: .5;"><?php echo e($cmp->get('contact')); ?></p>
            <p style="line-height: .5;"><?php echo e($cmp->get('email')); ?></p>
            <p style="line-height: .5;"><?php echo e($cmp->get('gstin')); ?></p>
        </td>
    ...
    <tr>
         <td width="20%" style="text-align: center;">
             <?php echo e($obj->invoice_no); ?>

        </td>
         <td width="20%" style="text-align: center;">
             <?php echo e($obj->invoice_date ?date('d-m-Y', strtotime($obj->invoice_date)):''); ?>
    ...
    <tr>
         <td width="20%" style="text-align: center;border-bottom: none;">
             <?php echo e($obj->style_name); ?>

        </td>
         <td width="20%" style="text-align: center;border-bottom: none;">
             <?php echo e($obj->style_desc); ?>
...
<table width="100%">
    <tr>
        <td rowspan="4" width="30%" style="">
            ...
            <p style=";padding-left: 10px;font-weight: bold;"><?php echo e($obj->contact_name); ?></p>
            <p style="font-size: 10px;line-height: .3;padding-left: 10px"><?php echo e($billing_address->get('address_1')); ?></p>
            <p style="font-size: 10px;line-height: .3;padding-left: 10px"><?php echo e($billing_address->get('address_2')); ?></p>
            <p style="font-size: 10px;line-height: .3;padding-left: 10px"><?php echo e($billing_address->get('address_3')); ?></p>
            <p style="font-size: 10px;line-height: .3;margin-bottom: 0;padding-left: 10px"><?php echo e($billing_address->get('gstcell')); ?></p>
        </td>
        <td rowspan="4" width="30%" style="">
            <p style="padding-top: 0;margin-top: 0;font-weight: bold;">Buyer :</p>
            <p style=";padding-left: 10px;font-weight: bold;"><?php echo e($obj->contact_name); ?></p>
    ...
    <tr>
        <td width="20%" style="text-align: center;">
            <?php echo e($obj->despatch_name); ?>

        </td>
        <td width="20%" style="text-align: center;">
            <?php echo e(date('d-m-Y', strtotime($obj->despatch_date))); ?>
    ...
    <tr>
        <td width="20%" style="text-align: center;">
            <?php echo e($obj->transport_name); ?>

        </td>
        <td width="20%" style="text-align: center;">
            <?php echo e($obj->transport_date); ?>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/pdf/garments/sales/vijay_garments.blade.php ENDPATH**/ ?>