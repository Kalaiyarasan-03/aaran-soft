        ...
        <td colspan="2" style="justify-items: center;">
            ...
            <div style="height: 110px;padding-left: 60px;" class="bg-blue-400 ">
                <div style="text-align: center;">
                    <div style="font-family:Times,serif;text-align: center; width: 100%;color: #3b82f6;font-size: 55px;" class="companyname"><?php echo e($cmp->get('company_name')); ?></div>
                </div>
                <div style="text-align: center; width: 100%;" ><?php echo e($cmp->get('address_1')); ?>,<?php echo e($cmp->get('address_2')); ?></div>
                <div style="text-align: center; width: 100%;" >&nbsp;<?php echo e($cmp->get('contact')); ?></div>
                <div style="text-align: center; width: 100%;"><?php echo e($cmp->get('gstin')); ?>&nbsp;-&nbsp; <?php echo e($cmp->get('msme')); ?></div>
            </div>
        </td>
    </tr>
    <tr>
    ...
    <?php if($obj->sales_type==0): ?>
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td align="center" style="border-bottom: none;border-top: none;"><?php echo e($row['po_no']); ?> </td>
                <td align="center" style="border-bottom: none;border-top: none;"><?php echo e($row['dc_no']); ?> </td>
                <td align="center" style="border-bottom: none;border-top: none;">&nbsp;<?php echo e($row['hsncode']); ?></td>
                <td align="left" style="border-bottom: none;border-top: none;">&nbsp;<?php echo e($row['product_name']); ?></td>
                ...
                <td align="right" style="border-bottom: none;border-top: none;">
                    &nbsp;<?php echo e(number_format(($row['qty']*$row['price']*$row['gst_percent']/100)/2,2,'.','')); ?></td>
                <td align="center"
                    style="border-bottom: none;border-top: none; border-left: none;"><?php echo e($row['gst_percent']); ?></td>
                <td align="center" style="border-bottom: none;border-top: none;">
                    &nbsp;<?php echo e(number_format(($row['qty']*$row['price']*$row['gst_percent']/100)/2,2,'.','')); ?></td>
                <td align="right" style="border-bottom: none;border-top: none; ">
                    &nbsp;<?php echo e(number_format($row['qty']*$row['price']*$row['gst_percent']/100+$row['qty']*$row['price'],2,'.','')); ?></td>
            </tr>

        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <?php for($i = 0; $i < 20-($list->count()*2); $i++): ?>
        ...
        <tr>
            ...
            <td colspan="5" align="left" style="border-bottom: none;border-right: none;">&nbsp;Add&nbsp;:&nbsp;<?php echo e($obj->ledger_name); ?>
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td colspan="2" align="right" style="border-bottom: none;border-top: none;">
                    &nbsp;<?php echo e(number_format(($row['qty']*$row['price']*($row['gst_percent']*2)/100),2,'.','')); ?></td>
                <td align="right" style="border-bottom: none;border-top: none; ">
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/pdf/offset/sales/sk_printers.blade.php ENDPATH**/ ?>