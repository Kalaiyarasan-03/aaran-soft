...
<?php foreach($attributes->onlyProps(['icon']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['icon']); ?>
<?php foreach (array_filter((['icon']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" <?php echo e($attributes); ?>>
    ...
    <!--[if BLOCK]><![endif]--><?php switch($icon):
        ...
        <?php case ('arrow-down-on-square-stack'): ?>
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <?php case ('location_outline'): ?>
            <path
                ...
                fill="currentColor"></path>
            <?php break; ?>
        <?php case ('dots-circle-horizontal'): ?>
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            <?php break; ?>
        <?php case ('color-swatch'): ?>
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<!-------  end line -------------->
<?php /**PATH D:\web-app\aaran-soft\resources\views/components/icons/icon.blade.php ENDPATH**/ ?>