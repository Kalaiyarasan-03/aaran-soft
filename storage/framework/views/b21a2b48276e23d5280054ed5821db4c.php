...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.icon','data' => ['icon' => 'book','class' => 'w-5 h-auto block']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('book'),'class' => 'w-5 h-auto block']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Accounts <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div x-show="selected === 339" class="p-1 flex flex-col">
        ...
        <ul class="grid-cols-1 grid bg-gray-800">
            ...
            <?php echo $__env->make('components.menu.items.accounts-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <li class="bg-gray-900 mt-0.5"></li>
        </ul>
    </div>
</li>
<?php /**PATH D:\web-app\aaran-soft\resources\views/components/menu/sub/accounts.blade.php ENDPATH**/ ?>