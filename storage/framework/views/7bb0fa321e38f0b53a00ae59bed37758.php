<button wire:click="print"
        class='inline-flex items-center px-4 py-2 border border-transparent
                               ...
                               focus:ring-purple-500 bg-purple-600 hover:bg-purple-500 active:bg-purple-700 border-purple-600'>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.icon','data' => ['icon' => 'printer','class' => 'h-5 w-auto block px-1.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('printer'),'class' => 'h-5 w-auto block px-1.5']); ?>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/components/button/print.blade.php ENDPATH**/ ?>