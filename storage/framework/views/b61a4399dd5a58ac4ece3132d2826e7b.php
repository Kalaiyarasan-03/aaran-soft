<div>
     <?php $__env->slot('header', null, []); ?> Pincode <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click.prevent' => 'sortBy(\'vname\')','center' => true]); ?>Pincode <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input.model-text','data' => ['wire:model' => 'vname','label' => 'Pincode']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'vname','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Pincode')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/livewire/common/pincode-list.blade.php ENDPATH**/ ?>