...
<h2 style="text-align: center">
    <div style="font-family:Times,serif; width: 100%;color: #3b82f6;"><?php echo e($cmp->get('company_name')); ?></div>
</h2>
<hr>
<div style="text-align: left;">
    Party Name :&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo e($contact->vname); ?></b>
</div>

<div style="text-align: center;font-size: 15px;padding: 10px;">
    <b>Statement&nbsp;<?php echo e($start_date.' to '.$end_date); ?></b>
</div>
...
<table width="100%">
    ...
    <tr>
        ...
        <td><?php echo e(number_format($old_balance,2,'.','')); ?></td>
        <td></td>
    </tr>
...
<?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        <td> <?php echo e(date('d-m-Y', strtotime($row->vdate))); ?></td>
        <td><?php echo e($row->vno); ?></td>
        <td> <?php echo e($row->mode); ?></td>
        <td> <?php echo e($row->chq_no); ?></td>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <tr>
        ...
        <td><b><?php echo e(number_format($totalSales+$old_balance,2,'.','')); ?></b></td>
        <td><b><?php echo e(number_format($totalReceipt,2,'.','')); ?></b></td>
    </tr>
    <tr>
        <td colspan="4" style="text-align: right;"><b>Balance</b></td>
        <td><b><?php echo e(number_format($totalSales+$old_balance-$totalReceipt,2,'.','')); ?></b></td>
        <td></td>
    </tr>
    </tbody>
</table>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/pdf/salesreport/report.blade.php ENDPATH**/ ?>