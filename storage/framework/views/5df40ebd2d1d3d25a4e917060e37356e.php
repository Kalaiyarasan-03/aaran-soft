...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.icon','data' => ['icon' => 'backward','class' => 'h-5 w-auto block px-1.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('backward'),'class' => 'h-5 w-auto block px-1.5']); ?>
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/components/button/back.blade.php ENDPATH**/ ?>