        ...
        <td colspan="2" style="justify-items: center;">
            <div style="height: 120px;" class="bg-blue-400 ">
                ...
                <img style="height: 40px;width: 55%;padding-top: 10px;"
                     src="<?php echo e(public_path('images/client_logo/bestprint.png')); ?>"/></div>
                <div style="text-align: center; width: 100%; padding-top: 12px;" ><?php echo e($cmp->get('address_1')); ?>,<?php echo e($cmp->get('address_2')); ?></div>
...
<table width="100%">
    ...
    <?php if($obj->sales_type==0): ?>
        <tr>
            ...
            <th colspan="2" width="20px" style="padding: 2px; border-left: none; margin-left: 0px;">GST Amt</th>
    ...
    <?php if($obj->sales_type==0): ?>
        ...
        <tr>
            ...
            <td colspan="5" align="left" style="border-bottom: none;border-right: none;">GST</td>
            <td align="right"
...
<?php /**PATH D:\web-app\aaran-soft\resources\views/pdf/offset/sales/best_print1.blade.php ENDPATH**/ ?>